...
/**
 * OroPhysicalStoreOrderItems
 *
 * @ORM\Table(name="oro_physicalstore_order_items")
 * @ORM\Entity()
 ...
 *          "entity"={
 *              "icon"="icon-ok-circle",
 *              "label"="PhysicalStore Order Items",
 *              "plural_label"="PhysicalStore Order Items",
 *              "description"="PhysicalStore Order Items"
 *          },
 *      "security"={
 *          "type"="ACL"
 *      },
 ...
 * )
 */
class OroPhysicalStoreOrderItems
{
    /**
     * @var integer
     *
