 ...
 *
 * @ORM\Table(name="oro_physicalstore_accounts")
 * @ORM\Entity()
 ...
 *          "entity"={
 *              "icon"="icon-ok-circle",
 *              "label"="PhysicalStore Account",
 *              "plural_label"="Physical Store Accounts",
 *              "description"="Physical Store Accounts"
 *          },
 *      "security"={
 *          "type"="ACL"
 *      },
 ...
 * )
 */
class OroPhysicalStoreAccounts
{
    const ENTITY_NAME = 'DemacMedia\Bundle\PhysicalStoreBundle\Entity\OroPhysicalStoreAccounts';
